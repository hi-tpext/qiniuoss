...
class Module  extends baseModule
{
    ...
    protected $name = 'builder.qiniuoss';

    protected $title = '七牛云OSS存储';

    protected $description = '支持七牛云OSS存储文件上传功能';
    ...
    {
        builderModule::getInstance()->addStorageDriver(OssStorage::class, '七牛云OSS存储');
    }
